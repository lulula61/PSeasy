...
def autumn(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    if x_start != None:
        roi = img[int(y_start):int(y_end), int(x_start):int(x_end)]
        result = color.convertchannel(roi)
        result_gray = cv2.cvtColor(result, cv2.COLOR_BGR2GRAY)
        result = cv2.applyColorMap(result_gray, cv2.COLORMAP_AUTUMN)
    ...
    '''
        ...
        if points == None:
            ...
            output = img.copy()
            output[mask != 0] = result_colored[mask != 0]

            return output
    '''


def bone(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    Img = img
    if x_start != None:
...
def jet(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    Img = img
    if x_start != None:
        img = img[int(y_start):int(y_end), int(x_start):int(x_end)]
    result = color.convertchannel(img)
...
def winter(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    Img = img
    if x_start != None:
        img = img[int(y_start):int(y_end), int(x_start):int(x_end)]
    result = color.convertchannel(img)
...
def rainbow(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    Img = img
    if x_start != None:
        img = img[int(y_start):int(y_end), int(x_start):int(x_end)]
    result = color.convertchannel(img)
...
def ocean(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    Img = img
    if x_start != None:
        img = img[int(y_start):int(y_end), int(x_start):int(x_end)]
    result = color.convertchannel(img)
...
def summer(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    Img = img
    if x_start != None:
        img = img[int(y_start):int(y_end), int(x_start):int(x_end)]
    result = color.convertchannel(img)
...
def spring(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    Img = img
    if x_start != None:
        img = img[int(y_start):int(y_end), int(x_start):int(x_end)]
    result = color.convertchannel(img)
...
def cool(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    Img = img
    if x_start != None:
        img = img[int(y_start):int(y_end), int(x_start):int(x_end)]
    result = color.convertchannel(img)
...
def hsv(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    Img = img
    if x_start != None:
        img = img[int(y_start):int(y_end), int(x_start):int(x_end)]
    result = color.convertchannel(img)
...
def pink(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    Img = img
    if x_start != None:
        img = img[int(y_start):int(y_end), int(x_start):int(x_end)]
    result = color.convertchannel(img)
...
def hot(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    Img = img
    if x_start != None:
        img = img[int(y_start):int(y_end), int(x_start):int(x_end)]
    result = color.convertchannel(img)
...
def gray(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    Img = img
    if x_start != None:
        img = img[int(y_start):int(y_end), int(x_start):int(x_end)]
    result = color.convertchannel(img)
...
def sketch(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    Img = img
    if x_start != None:
        img = img[int(y_start):int(y_end), int(x_start):int(x_end)]
    result = color.convertchannel(img)
...
def cartoon(img, x_start=None, y_start=None, x_end=None, y_end=None, points=None):
    Img = img
    if x_start != None:
        img = img[int(y_start):int(y_end), int(x_start):int(x_end)]
    result = color.convertchannel(img)
...
if __name__ == '__main__':
    pth = "E:\Me\College\大三下\软件工程原理\大作业\imgs\img2.png"
